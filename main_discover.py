...
parser.add_argument("--dataset", choices=["SemanticKITTI", "SemanticPOSS", "Toronto3D", "S3DIS", "WhuMLS"], default="S3DIS", type=str, help="dataset")
...
parser.add_argument("--num_iters_sk", default=3, type=int, help="number of iters for Sindhorn")
...
parser.add_argument("--entity", default="yaotangjun123-tongji-university")
