...
# from models.multiheadminkunet_input import MultiHeadMinkUnet
...
class Discoverer(pl.LightningModule):
    ...
    def training_step(self, data, _):
        ...
        if self.current_epoch < 10:
            ...
            _levels  = [2, 1]                
            _level_w = {2: 1.0, 1: 0.6}
        else:
            _levels  = [2, 1, 0]              
            _level_w = {2: 1.0, 1: 0.6, 0: 0.3}

        _level_alpha = {2: 0.60, 1: 0.60, 0: 0.60}
        ...
        if (
            ...
            with tqdm(
                ...
                for step, data in enumerate(dataloader):
                    coords, feats, real_labels, _, mapped_labels, _, _ = data
    ...
    def validation_step(self, data, batch_idx):
        coords, feats, real_labels, _, _, _, scene_info = data
